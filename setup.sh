...
# Define repositories
declare -A REPOS=(
    ["device/nothing/Pong"]="https://github.com/Pong-Development/device_nothing_Pong_priv.git"
    ["vendor/nothing/Pong"]="https://github.com/Pong-Development/vendor_nothing_Pong_priv.git"
